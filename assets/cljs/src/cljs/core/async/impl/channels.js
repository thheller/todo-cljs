...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t10465 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t10465 = (function (val,box,meta10466){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t10465.cljs$lang$type = true;
cljs.core.async.impl.channels.t10465.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t10465";
cljs.core.async.impl.channels.t10465.cljs$lang$ctorPrWriter = (function (this__4675__auto__,writer__4676__auto__,opt__4677__auto__){return cljs.core._write(writer__4676__auto__,"cljs.core.async.impl.channels/t10465");
});
cljs.core.async.impl.channels.t10465.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t10465.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10467){var self__ = this;
var _10467__$1 = this;return self__.meta10466;
});
cljs.core.async.impl.channels.t10465.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10467,meta10466__$1){var self__ = this;
var _10467__$1 = this;return (new cljs.core.async.impl.channels.t10465(self__.val,self__.box,meta10466__$1));
});
cljs.core.async.impl.channels.__GT_t10465 = (function __GT_t10465(val__$1,box__$1,meta10466){return (new cljs.core.async.impl.channels.t10465(val__$1,box__$1,meta10466));
});
}
return (new cljs.core.async.impl.channels.t10465(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4678__auto__,writer__4679__auto__,opts__4680__auto__){return cljs.core._write(writer__4679__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4675__auto__,writer__4676__auto__,opt__4677__auto__){return cljs.core._write(writer__4676__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_10468 = self__.takes.pop();if((taker_10468 == null))
{} else
{if(taker_10468.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_10469 = taker_10468.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_10469,taker_10468){
return (function (){return (take_cb_10469.cljs$core$IFn$_invoke$arity$1 ? take_cb_10469.cljs$core$IFn$_invoke$arity$1(null) : take_cb_10469.call(null,null));
});})(take_cb_10469,taker_10468))
);
} else
{}
{
