...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4675__auto__,writer__4676__auto__,opt__4677__auto__){return cljs.core._write(writer__4676__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_10471 = 0;while(true){
if((i_10471 < arr.length))
{(arr[i_10471] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4675__auto__,writer__4676__auto__,opt__4677__auto__){return cljs.core._write(writer__4676__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_10478 = (self__.level + 1);while(true){
if((i_10478 <= (new_level + 1)))
{(update[i_10478] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_10480 = 0;while(true){
if((i_10480 <= self__.level))
{var links_10481 = (update[i_10480]).forward;if(((links_10481[i_10480]) === x__$1))
{(links_10481[i_10480] = (x__$1.forward[i_10480]));
{
var G__10482 = (i_10480 + 1);
i_10480 = G__10482;
continue;
}
} else
{{
var G__10483 = (i_10480 + 1);
i_10480 = G__10483;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__4126__auto__ = (cljs.core.truth_((function (){var and__4114__auto__ = me;if(cljs.core.truth_(and__4114__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__4114__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__4126__auto__))
